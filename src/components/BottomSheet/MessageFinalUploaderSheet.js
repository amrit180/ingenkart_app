...
const MAX_TRANSALTE_Y = -height / 1.25;

const MessageFinalUploaderSheet = ({ childref, handleSubmit }) => {
  ...
  return (
    <>
      ...
      >
        <ChatFinalUploaderBox handleSubmit={handleSubmit} scrollTo={scrollTo} />
      </Animated.View>
...
export default MessageFinalUploaderSheet;
